<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Edit Training Plan: {{ $trainingPlan->plan_name }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('training-plans.update', $trainingPlan->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="plan_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" 
                            ...
                            <div>
                                ...
                                <input type="date" name="start_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" 
                                       value="{{ old('start_date', $trainingPlan->start_date) }}" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="end_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" 
                                       value="{{ old('end_date', $trainingPlan->end_date) }}" required>
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="details" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('details', $trainingPlan->details) }}</textarea>
                        </div>
