<div wire:poll.5s> {{-- ⚡ POLLING: Updates every 5 seconds --}}
    
    {{-- ================================================================= --}}
    {{-- 1. FLOATING NOTIFICATION BELL (Bottom-Right)                      --}}
    {{-- ================================================================= --}}
    <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end" 
        ...
        <div x-show="open" 
            ...
            <div class="p-4 bg-gradient-to-r from-slate-900 to-slate-800 text-white flex justify-between items-center">
                ...
                @if($unreadCount > 0)
                    <button wire:click="markAllAsRead" class="text-[10px] bg-white/20 hover:bg-white/30 px-2 py-1 rounded transition">
                        Mark all read
                    </button>
                @endif
            </div>

            <div class="max-h-80 overflow-y-auto custom-scroll bg-white">
                @forelse($notifications as $notification)
                    {{-- 
                        ITEM LINK:
                        - Direct link with ?read=ID for instant redirect & read marking.
                        - Dynamic Class: 
                            - UNREAD: 'bg-blue-50/50 hover:bg-blue-100'
                       ...
                       class="block w-full text-left px-4 py-3 border-b border-gray-100 transition-all relative group
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                {{-- Name: Darker if unread, lighter if read --}}
                            ...
                            {{-- 🔵 Blue Dot: Show ONLY if notification is UNREAD --}}
        ...
        {{-- Floating Button --}}
        <button @click="open = !open" class="relative group outline-none">
            ...
            {{-- Red Badge Count (Shows count of UNREAD items only) --}}
            @if($unreadCount > 0)
    ...
    {{-- ================================================================= --}}
    {{-- 2. SEPARATE TOAST ALERT (Top-Right)                               --}}
    {{-- ================================================================= --}}
