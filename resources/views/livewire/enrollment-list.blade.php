<div wire:poll.5s> {{-- ⚡ AUTO-REFRESH EVERY 5 SECONDS --}}
    ...
    {{-- Notification --}}
    @if(session('success'))
        <div class="mb-6 bg-green-50 border-l-4 border-green-500 text-green-700 p-4 rounded shadow-sm animate-fade-in-down">
            {!! session('success') !!}
        </div>
    @endif
        ...
        <div class="p-6 text-gray-900">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex items-center gap-2">
                    {{-- Loading Indicator --}}
                    <div wire:loading class="text-xs text-indigo-500 italic font-bold">
                        Checking for updates...
                    </div>
                    <span class="text-xs text-gray-500 italic">Auto-refreshing list...</span>
                </div>
            </div>
