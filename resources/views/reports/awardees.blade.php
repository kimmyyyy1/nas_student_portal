<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex md:hidden items-center w-full py-2">
            <span class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-bold bg-yellow-100 text-yellow-700 tracking-wide uppercase shadow-sm border border-yellow-200">
                <svg class="w-3 h-3 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
                Honors & Awards
            </span>
        </div>
        ...
        <div class="hidden md:flex items-center justify-between w-full py-2">
            ...
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Academic Awardees & Ranking') }}
                </h2>
            </div>

            {{-- KANAN: Badge --}}
            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-yellow-100 text-yellow-700 tracking-wide uppercase shadow-sm border border-yellow-200">
                <svg class="w-3 h-3 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
                Honors & Awards
            </span>
                        ...
                        <form action="#" method="GET"> 
                            ...
                            <div class="mb-4">
                                ...
                                <select class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                    ...
                                    <option value="Final">Final Ranking</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-6">
                                <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Section (Optional)</label>
                                <select class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            ...
                            <button type="button" class="w-full bg-indigo-700 hover:bg-indigo-800 text-white font-bold py-2.5 px-4 rounded shadow-md transition text-sm flex justify-center items-center group">
                                <svg class="w-4 h-4 mr-2 group-hover:animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                                Generate Awardees
                            </button>
                        </form>
                    </div>
                ...
                <div class="md:col-span-3">
                    <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200 min-h-[500px]">
                        ...
                        <div class="flex flex-col items-center justify-center h-96 text-center p-8">
                            ...
                            <h4 class="text-xl font-bold text-gray-800">Generate Awardees List</h4>
                            <p class="text-gray-500 max-w-sm mt-2">
                                Use the filters on the left to identify students eligible for <strong>With Honors</strong>, <strong>High Honors</strong>, and <strong>Highest Honors</strong>.
                            </p>
                        </div>
