<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <span class="text-xs font-bold text-yellow-600 bg-yellow-100 px-2 py-1 rounded-full uppercase tracking-wide">
                Honors & Awards
            </span>
        </div>
    </x-slot>
                ...
                <div class="md:col-span-3">
                    <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200 min-h-[500px]">
                        ...
                        <div class="bg-gray-50 border-b border-gray-200 px-6 py-4 flex justify-between items-center">
                            <h3 class="text-sm font-bold text-gray-700">List of Honors</h3>
