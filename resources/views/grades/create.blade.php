                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="grading_period" id="grading_period" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                    ...
                                    <option value="1st Quarter" {{ old('grading_period') == '1st Quarter' ? 'selected' : '' }}>1st Quarter</option>
                                    <option value="2nd Quarter" {{ old('grading_period') == '2nd Quarter' ? 'selected' : '' }}>2nd Quarter</option>
                                    <option value="3rd Quarter" {{ old('grading_period') == '3rd Quarter' ? 'selected' : '' }}>3rd Quarter</option>
                                    <option value="4th Quarter" {{ old('grading_period') == '4th Quarter' ? 'selected' : '' }}>4th Quarter</option>
                                    </select>
                            </div>

                            <div>
                                <label for="mark" class="block text-sm font-medium text-gray-700">Mark (e.g., 95.50)</label>
                                <input type="number" step="0.01" name="mark" id="mark" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('mark') }}" required>
                            </div>
