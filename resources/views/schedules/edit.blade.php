                    ...
                    <form method="POST" action="{{ route('schedules.update', $schedule->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="day" id="day" placeholder="e.g., MWF or TTh" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('day', $schedule->day) }}" required>
                            </div>

                            <div>
                                <label for="time_start" class="block text-sm font-medium text-gray-700">Time Start</label>
                                {{-- 
                                    Ginamit natin ang date('H:i', ...) para alisin ang segundo
                                    at siguradong ma-prefill ang input field
                                --}}
                                <input type="time" name="time_start" id="time_start" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" 
                            ...
                            <div>
                                ...
                                <input type="time" name="time_end" id="time_end" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" 
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="room" id="room" placeholder="e.g., Room 101" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('room', $schedule->room) }}">
                            </div>
