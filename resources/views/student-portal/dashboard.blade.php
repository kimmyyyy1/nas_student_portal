<x-student-layout>
    ...
    <div class="py-6 sm:py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-4">
            ...
            {{-- ========================== --}}
            <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-6 sm:mb-8 border-l-8 border-indigo-700">
                ...
                <div x-data="{ showInfo: false }" class="border-t border-gray-100">
                    <button @click="showInfo = !showInfo" class="w-full text-center py-3 sm:py-2 text-xs text-gray-500 hover:bg-gray-50 flex justify-center items-center bg-gray-50 transition active:bg-gray-200">
                    ...
                    <div x-show="showInfo" x-transition class="p-4 sm:p-6 bg-white grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 text-sm border-t">
                        <div>
            ...
            @if(isset($student->promotion_status) && $student->promotion_status)
                ...
                <div class="mb-6 sm:mb-8 bg-white shadow-md rounded-lg border-l-8 {{ $borderClass }} p-4 sm:p-6 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left">
            ...
            {{-- 3. CLASS SCHEDULE          --}}
            {{-- ========================== --}}
            <div x-data="{ showSchedule: false }" class="bg-white shadow-md rounded-lg overflow-hidden mb-6 sm:mb-8 border border-gray-200">
                <button @click="showSchedule = !showSchedule" class="w-full p-4 bg-blue-50 border-b border-gray-200 flex justify-between items-center hover:bg-blue-100 transition active:bg-blue-200">
                ...
                <div x-show="showSchedule" style="display: none;" class="p-0 sm:p-4 bg-white transition-all duration-300">
