<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center font-poppins-override"> {{-- Added class here --}}
    ...
    <div class="py-12 font-poppins-override"> {{-- Added class here to cover the main content --}}
