    ...
    <x-slot name="header">
        ...
        <div class="flex md:hidden items-center justify-between w-full py-1">
            ...
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-orange-100 text-orange-700 uppercase shadow-sm border border-orange-200">
                <i class='bx bxs-door-open mr-1.5 text-sm'></i> Add Section
            </span>
                    ...
                    <form method="POST" action="{{ route('sections.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="section_name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 text-sm" required value="{{ old('section_name') }}" placeholder="e.g. Emerald">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-gray-500 mt-1 italic">Select from registered teachers.</p>
                            </div>

                            {{-- Room Number --}}
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Room Number (Optional)</label>
                                <input type="text" name="room_number" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 text-sm" value="{{ old('room_number') }}" placeholder="e.g. Bldg A - Rm 101">
                            </div>
