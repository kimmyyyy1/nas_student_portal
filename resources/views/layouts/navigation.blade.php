...
<div x-data="{ open: false }">
    ...
    {{-- 3. SIDEBAR --}}
    {{-- h-[100dvh]: Sinisigurado na sakop ang buong height kahit may browser address bar sa mobile --}}
    <nav :class="{'translate-x-0': open, '-translate-x-full': !open}"
        ...
        {{-- 
            ...
            shrink-0: Para hindi lumiliit o ma-squish 
        --}}
        ...
        {{-- 
            ...
            flex-1 relative: Ito ang kukuha ng natitirang space sa gitna.
            min-h-0: Importante para gumana ang scroll sa loob ng flexbox.
        --}}
        <div class="flex-1 relative min-h-0">
            
            {{-- @persist: Pinipigilan ang pag-refresh ng element na 'to --}}
            @persist('sidebar-scroll-area')
                
                {{-- 
                    absolute inset-0: Ito ang susi! 
                    Pinipilit nito ang div na magkasya lang sa loob ng parent wrapper. 
                    Dahil dito, ang overflow ay gagana nang tama.
                --}}
                <div class="absolute inset-0 overflow-y-auto no-scrollbar py-2">
        ...
        {{-- shrink-0: Para hindi ito mapipitpit o mawawala --}}
        <div class="shrink-0 p-4 border-t border-gray-200/50 bg-gray-50/80 backdrop-blur-sm">
